...
const FooterSection = () => {
    return (<div className="absolute bottom-0 left-0 w-full justify-between items-center pt-20 px-8 text-black" style={{ height: `5px` }}>
      <footer className="border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 sm:px-8">
          ...
          <div className="mt-8 text-center text-sm text-gray-500 flex justify-center space-x-4">
            <span>© Zenstays. All rights reserved.</span>

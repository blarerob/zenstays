...
const HeroSection = () => {
    return (<div className='relative h-screen'>
         <Image src="/cover.jpg" alt="Zen Stays Cover" fill className='pt-8 md:pt-8 object-cover object-center' quality={100} priority/>

         <div className="absolute inset-0" style={{ backgroundColor: "rgba(0, 0, 0, 0.4)" }}/>
         <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="absolute inset-0 flex flex-col items-center justify-center text-center">
             ...
             <div className="max-w-4xl px-16 sm:px-12 mt-16">
                 ...
                 <div className="justify-center mt-14 flex items-center">
                     <Input placeholder='Enter Email Now for Free Consultation!' className="w-75 rounded-none rounded-l-xl border-none bg-white h-12"/>
                     <button className="bg-[#766a55] text-white rounded-none
                         rounded-r-xl pr-2 pl-2 border-none hover:bg-secondary h-12" onClick={async () => {
            try {

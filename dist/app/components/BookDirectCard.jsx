...
const BookDirectCard = () => {
    return (<div className="flex flex-col items-center bg-white shadow-md rounded-lg overflow-hidden">
            <div className="relative w-full h-64">
                <Image src={exampleHouses[0].src} alt={exampleHouses[0].alt} layout="fill" objectFit="cover" className="rounded-t-lg"/>
            </div>

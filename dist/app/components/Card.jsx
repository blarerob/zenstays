...
const Card = ({ property, isFavorite, onFavoriteToggle, showFavoriteButton }) => {
    var _a, _b, _c, _d;
    const defaultImages = [
    ...
    return (<div className="bg-white rounded-xl overflow-hidden shadow-lg w-full mb-2">
      <div className="relative">
        <div className="w-full h-80 relative overflow-hidden">
          <Image src={(property === null || property === void 0 ? void 0 : property.image) || defaultImages[0]} alt={(property === null || property === void 0 ? void 0 : property.name) || "Property Image"} fill className={`object-cover transition-opacity duration-300 ease-in-out ${transitionClass}`}/>
        </div>
      ...
      <div className="p-4">
        <p className="text-gray-600 mb-2">
          {(_a = property === null || property === void 0 ? void 0 : property.location) === null || _a === void 0 ? void 0 : _a.address} {(_b = property === null || property === void 0 ? void 0 : property.location) === null || _b === void 0 ? void 0 : _b.city}
        </p>
        <div className="flex justify-between items-center">
          <div className="flex items-center mb-2">
            <Star className="w-4 h-4 text-yellow-400 mr-1"/>
            <span className="font-semibold">
              {(_c = property === null || property === void 0 ? void 0 : property.averageRating) === null || _c === void 0 ? void 0 : _c.toFixed(1)}
            </span>
          ...
          <p className="text-lg font-bold mb-3">
            ${(_d = property === null || property === void 0 ? void 0 : property.pricePerMonth) === null || _d === void 0 ? void 0 : _d.toFixed(0)}{" "}
        ...
        <div className="flex justify-between items-center gap-4 text-gray-600 mt-5">
          <span className="flex items-center">
            ...
            {property === null || property === void 0 ? void 0 : property.beds} Bed
          </span>
          <span className="flex items-center">
            <Bath className="w-5 h-5 mr-2"/>
            {property === null || property === void 0 ? void 0 : property.baths} Bath
          </span>
          <span className="flex items-center">
            <House className="w-5 h-5 mr-2"/>
            {property === null || property === void 0 ? void 0 : property.squareFeet} sq ft
          </span>
        </div>
      </div>

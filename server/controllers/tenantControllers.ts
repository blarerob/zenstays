...
export const getTenant = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        res
            .status(500)
            .json({ message: `Error retrieving tenant: ${error}` });
    }
};
...
export const updateTenant = async (
    ...
    try {
        ...
        res
            .status(500)
            .json({ message: `Error updating tenant: ${error}` });
    }
};
...
export const getCurrentResidences = async (
    ...
    try {
        ...
        const residencesWithFormattedLocation = await Promise.all(
            properties.map(async (property: { location: { id: never; }; }) => {
        ...
        res
            .status(500)
            .json({ message: `Error retrieving manager properties: ${err}` });
    }
};
...
export const removeFavoriteProperty = async (
    ...
    try {
        ...
        res
            .status(500)
            .json({ message: `Error removing favorite property: ${err}` });
    }
};